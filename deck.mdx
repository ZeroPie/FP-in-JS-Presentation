...
```js title='Less Code, less Changes, maybe less Bugs' subtilte='Point Free/Tacit Style: You don't specify arguments, functions are defined as products from other functions'

...
```js title='Function in JS'
    ...
    Subprograms with params, bodies and return values  // etc ..
...
```js title='Benefits of being Callable' subtitle="Not using the benefits" 
  httpGet('/post/2', json => renderPost(json));
```

```js title='Benefits of being Callable' subtitle="We have to refactor and add error" 
  httpGet('/post/2', (json, err) => renderPost(json, err));
```

```js title='Benefits of being Callable' subtitle="We don't need to change much"
